...
let sunSizes = [];
let grainOfSalt = new SunSize(0, "Grain Of Salt", "grains of salt", 0.334, "salt.jpg");
...
// default results
let defaultResultsObject = new Results(grainOfSalt, earth);
...
{
    this.SelectedSunObject = selectedSunSize;
    this.SelectedTargetObject = selectedTarget;
    ...
    // this.TargetName = selectedTarget.Name;
    // this.TargetDescription = selectedTarget.Description;
    // this.TargetMilesFromSun = utilities.FormatWithCommas(selectedTarget.DistanceInMiles, 2);
    // this.MMsAwayFromTarget = selectedTarget.DistanceInMiles / (diameterOfSunInMiles / selectedSunSize.MMSize);
    // this.MMsAwayFromTargetFormatted = utilities.FormatWithCommas(selectedTarget.DistanceInMiles / (diameterOfSunInMiles / selectedSunSize.MMSize), 2);
    // this.InchesAwayFromTarget = (selectedTarget.DistanceInMiles / (diameterOfSunInMiles / selectedSunSize.MMSize) / mmsInAnInch);
    // this.InchesAwayFromTargetFormatted = utilities.FormatWithCommas((selectedTarget.DistanceInMiles / (diameterOfSunInMiles / selectedSunSize.MMSize) / mmsInAnInch),2);
    // this.FeetAwayFromTarget = ((selectedTarget.DistanceInMiles / (diameterOfSunInMiles / selectedSunSize.MMSize) / mmsInAnInch) / inchesInFoot);
    // this.FeetAwayFromTargetFormatted = utilities.FormatWithCommas(((selectedTarget.DistanceInMiles / (diameterOfSunInMiles / selectedSunSize.MMSize) / mmsInAnInch) / inchesInFoot), 2);
    // this.UnitsBetweenSunAndTarget = utilities.FormatWithCommas((selectedTarget.DistanceInMiles / (diameterOfSunInMiles / selectedSunSize.MMSize)) * (selectedSunSize.MMSize * 10), 2);
};
...
const App = () =>
{
    ...
    const SizeChanged = () =>
    {
        ...
        let selectedSunObject = sunSizes[selectedSunSize];
        resultsObject.SelectedSunObject = selectedSunObject;
    ...
    const TargetChanged = () => {
        ...
        let selectedTagrgetObject = targets[selectedTarget];
        resultsObject.SelectedTargetObject = selectedTagrgetObject;
        setResultsObject(resultsObject);
    ...
    return (<div className="container">
                <div className="row">
                    <div className="col-12">
                        ...
                        {/* <ResultsDisplay /> */}
                        <ResultsDisplayNew ResultsData={resultsObject} />
                    </div>
                </div>
            </div>
    );
